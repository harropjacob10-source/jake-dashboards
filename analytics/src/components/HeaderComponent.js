...
class HeaderComponent {
  constructor(container, options = {}) {
    ...
    this.options = {
      title: options.title || 'Jake\'s Analytics Dashboard',
      subtitle: options.subtitle || 'Real-time monitoring and analytics — built by Jake Harrop',
        ...
        <div class="header-content">
          ...
          <div class="header-right">
            ...
            ${this.options.showGitHubLink ? `
              <a href="https://github.com/harropjacob10-source" target="_blank" class="github-link" title="View on GitHub">
